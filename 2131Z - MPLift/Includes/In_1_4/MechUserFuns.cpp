...
void Lift(){
    ...
    if(Controller1.ButtonL1.pressing() && LiftMax == true) {
        ...
        RevLiftMotor.rotateTo(200,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
    }
    else if(Controller1.ButtonLeft.pressing()) {
        RevLiftMotor.rotateTo(302,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
    }
    else if(Controller1.ButtonDown.pressing()) {
        RevLiftMotor.rotateTo(150,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
    }
    else {
        RevLiftMotor.stop();
    }
